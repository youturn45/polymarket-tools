...
python examples/example1_run_monitors.py
...
python examples/example2_track_order.py \
    --token-id <token_id> \
    --side BUY \
    --price 0.50 \
    --size 100
...
**File:** `example3_kelly_micro_price_order.py`
